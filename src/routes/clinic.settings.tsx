            ...
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Automatically confirm patient bookings without manual review.
                </p>
              </div>
            </label>
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Patients can cancel up to 2 hours before the scheduled time.
                </p>
              </div>
            </label>
          </div>
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Receive an email summary of the day's schedule at 8 AM.
                </p>
              </div>
            </label>
          </div>
